...
export default {
    ...
    translation: {
        ...
        "prompt.copy.mode{0}": "Enter a copy mode option [Single/Multiple] <{0}>",
        // Trim and Extend commands
        "prompt.trim.mode": "Enter a trim mode option, ESC key to cancel",
        "prompt.trim.mode{0}": "Enter a trim mode option [Quick/Standard] <{0}>",
        "prompt.extend.mode": "Enter an extend mode option, ESC key to cancel",
        "prompt.extend.mode{0}": "Enter an extend mode option [Quick/Standard] <{0}>",
        // Stretch command
