...
export const I18N_KEYS = [
    ...
    "dialog.title.dimensionStyleModify:{0}",
    "dialog.title.dimensionStyleManager",
    "dialog.title.dimensionStyleNew",
    "dialog.title.dimensionStyleCompare",
    "dialog.title.dimensionStyleOverride:{0}",
    ...
    "dimstyle.manager.styles",
    "dimstyle.manager.setCurrent",
    "dimstyle.manager.new",
    "dimstyle.manager.modify",
    "dimstyle.manager.override",
    "dimstyle.manager.compare",
    "dimstyle.manager.overrideRow",
    "dimstyle.manager.describeCurrent:{0}",
    "dimstyle.manager.describeStyle:{0}",
    "dimstyle.manager.describeOverride:{0}",
    "dimstyle.manager.newName",
    "dimstyle.manager.startFrom",
    "dimstyle.manager.compareWith",
    "dimstyle.manager.compareTo",
    "dimstyle.manager.setting",
    "dimstyle.manager.variable",
    "dimstyle.manager.noDifferences",
    "dimstyle.manager.error.empty",
    "dimstyle.manager.error.tooLong",
    "dimstyle.manager.error.invalidChars",
    "dimstyle.manager.error.duplicate",
    // Dimension style
    ...
    "dimstyle.lineType.byBlock",
    "dimstyle.lineType.byLayer",
    "dimstyle.lineType.solid",
    "dimstyle.lineType.dash",
    "dimstyle.lineType.hidden",
    "dimstyle.lineType.dot",
    "dimstyle.lineWeight.byBlock",
    "dimstyle.lineWeight.byLayer",
    "dimstyle.lineWeight.default",
    "dimstyle.field.linetype",
    "dimstyle.field.linetypeExt1",
    "dimstyle.field.linetypeExt2",
    ...
    "error.chamfer.angleDoesNotReach",
    "error.corner.wireTooShort",
    ...
    "layer.column.lock",
    "layer.column.color",
    "layer.column.lineType",
    "layer.column.lineWeight",
    "layer.column.transparency",
    "layer.column.plot",
    "layer.column.count",
    "layer.column.count.full",
    ...
    "option.ellipse.mode",
    "option.ellipse.mode.axisEnd",
    "option.ellipse.mode.center",
    "option.polygon.fit",
    ...
    "prompt.ellipse.axisEnd",
    "prompt.ellipse.axisEndpoint",
    "prompt.ellipse.axisStart",
    "prompt.ellipse.center",
    "prompt.ellipse.otherAxis",
    "prompt.polygon.radiusCircumscribed",
    "prompt.polygon.radiusInscribed",
    "prompt.polygon.sides",
    ...
    "prompt.corner.selectFirst",
    "prompt.corner.selectSecond",
    "prompt.corner.selectFirstObject",
    "prompt.corner.selectSecondObject",
    "prompt.chamfer.firstDistance",
    "prompt.chamfer.secondDistance",
    "prompt.chamfer.angleDistance",
    "prompt.chamfer.angle",
    "prompt.chamfer.polyline",
    "prompt.chamfer.trimMode",
    "prompt.chamfer.method",
    ...
    "prompt.option.axisEnd",
    "prompt.option.chamfer",
    "prompt.option.circumscribed",
    "prompt.option.inscribed",
    ...
    "prompt.option.undo",
    "prompt.option.angle",
    "prompt.option.distance",
    "prompt.option.method",
    "prompt.option.multiple",
    "prompt.option.polyline",
    "prompt.option.trim",
    "prompt.option.twoPoint",
    // The word an option goes by inside the prompt's brackets - see StepOption.name.
    "prompt.optionName.axisEnd",
    "prompt.optionName.center",
    "prompt.optionName.chamfer",
    "prompt.optionName.circumscribed",
    "prompt.optionName.inscribed",
    ...
    "prompt.optionName.angle",
    "prompt.optionName.distance",
    "prompt.optionName.method",
    "prompt.optionName.multiple",
    "prompt.optionName.polyline",
    "prompt.optionName.trim",
    "prompt.optionName.noTrim",
    "option.command.chamferMethod.distance",
    "option.command.chamferMethod.angle",
    "option.command.trimMode.trim",
    "option.command.trimMode.noTrim",
    ...
    // Share - the version 1 invitation; see shareDocument.ts
    "share.promo.aiBody",
    "share.promo.aiTitle",
    "share.promo.copied",
    "share.promo.copy",
    "share.promo.done",
    "share.promo.footnote",
    "share.promo.headline",
    "share.promo.intro",
    "share.promo.liveBody",
    "share.promo.liveTitle",
    "share.promo.share",
    "share.promo.soon",
    "share.promo.storageBody",
    "share.promo.storageTitle",
    "share.promo.title",
    // Shortcuts
    "shortcuts.title",
    ...
    "shortcuts.group.modify",
    "shortcuts.close",
    "shortcuts.on",
    "shortcuts.off",
    "shortcuts.hint",
    "shortcuts.commandHistory",
    "shortcuts.commandHistoryTip",
    "shortcuts.help",
    "shortcuts.helpTip",
    "shortcuts.repeat",
    // StatusBar
