import { Binding, type IDocument, Localize, type Property, PubSub, Transaction } from "@draftworks/core";
import { ColorConverter, div, input, label } from "@draftworks/element";
